...
namespace LA {
  ...
  class Var : public Item {
    public:
      ...
      virtual std::shared_ptr<Var> Copy(std::string code) = 0;
    protected:
  ...
  class Code : public Var {
    public:
      ...
      std::shared_ptr<Var> Copy(std::string code) override;
  ...
  class Instruction {
    public:
      ...
      virtual std::shared_ptr<Function> GetParent();
      virtual void SetParent(std::shared_ptr<Function> parent);
  ...
  class LabelInst : public Instruction {
    public:
      LabelInst(std::shared_ptr<Label> label);
      std::string GenerateCode() override;
      std::string ToString() override;
    private:
  ...
  struct Function {
    ...
    std::map<std::string, std::shared_ptr<Label>> labels_mapper;
